"""The text report sink: layout, tables, amounts, and every Type, Detail, note, and error text (tech-docs 003)."""
...
def test_amounts_print_in_their_currencys_format() -> None:
    ...
    day_1 = TextReportSink.render((day_1_report,)).split("\n")
    day_5 = TextReportSink.render((day_5_report,)).split("\n")
...
def test_a_step_that_generates_nothing_prints_its_note() -> None:
    ...
    aed_only_text = TextReportSink.render((aed_only_report,))
