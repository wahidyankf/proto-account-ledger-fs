module AccountLedgerCli.Tests.Unit.Suite
...
let private buildScenarioData () : seq<obj[]> =
    ...
    if Array.isEmpty resources then
        failwith "no embedded .feature resource was found for the account-ledger-cli unit corpus"
