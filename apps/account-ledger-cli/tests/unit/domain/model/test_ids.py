...
def test_authorization_id_refuses_a_malformed_value() -> None:
    """An authorization ID is `Auth-` and letters or digits; any other text is a fault."""
    ...
    with pytest.raises(ValueError, match="an authorization ID is Auth- and letters or digits"):
