...
What was done, and when. Times are local (UTC+07:00). Each entry is written when its work happens, except the first
four, which were reconstructed on 2026-09-24 at 14:48 from git commit times and file creation times; no earlier work is
claimed.
