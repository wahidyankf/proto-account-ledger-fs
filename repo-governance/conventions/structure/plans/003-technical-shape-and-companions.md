---
description: >-
  Permits exactly one of two technical shapes per plan and fixes the contiguous numbered naming that ordered companions
  must use.
when_to_use: >-
  Use when choosing between a single technical document and a companion set, or when naming or reordering companions.
---
