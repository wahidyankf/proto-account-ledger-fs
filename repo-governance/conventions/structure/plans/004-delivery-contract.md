---
description: >-
  Defines what a delivery checklist item must contain, how executors are labelled, and what state a plan carries so a
  cold executor can resume.
when_to_use: >-
  Use when writing or reviewing delivery.md, or when deciding whether an item may be assigned to a human.
---
