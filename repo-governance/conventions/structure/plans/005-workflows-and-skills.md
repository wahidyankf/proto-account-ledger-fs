---
description: >-
  States which capability each plan lifecycle stage requires, and how workflows, skills, and agents divide
  responsibility for providing it.
when_to_use: >-
  Use when checking that a repository can run the whole plan lifecycle, or when deciding whether new guidance is a
  workflow or a skill.
---
